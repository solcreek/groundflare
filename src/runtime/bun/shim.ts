...
export function generateBunShim(opts: BunShimOptions): string {
  ...
  return [
    ...
    '//     binding — \`${STATE_BASE_DIR}/kv/<binding>.sqlite\`. Adapters are',
    '//     opened once at startup; bun:sqlite connections are safe to',
    '//     reuse across Bun.serve concurrency.',
    '// D1: Phase 2c stubs — replaced by bun:sqlite wrapper next.',
